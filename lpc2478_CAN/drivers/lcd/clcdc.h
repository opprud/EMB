/*****************************************************************************
 *   clcdc.h:  Header file for NXP LPC23xx/24xx Family Microprocessors
 *
 ...
 **********************************************************************/
#undef _BIT
#define _BIT(p)	(((unsigned long)(1)) << (p))
 ...
 **********************************************************************/
#undef _SBF
#define _SBF(p,v) (((unsigned long)(v)) << (p))
...
typedef struct 
{
  volatile unsigned long lcdtiming0;         /* LCD horizontal axis plane control register */
  volatile unsigned long lcdtiming1;         /* LCD vertical axis plane control register */
  volatile unsigned long lcdtiming2;         /* LCD clock and signal polarity control register */
  volatile unsigned long lcdtiming3;         /* LCD line end control register */
  volatile unsigned long lcdupbase;          /* LCD upper plane frame base address register */
  volatile unsigned long lcdlpbase;          /* LCD lower plane frame base address register */
  volatile unsigned long lcdctrl;            /* LCD control register */
  volatile unsigned long lcdimsc;            /* LCD interrupt mask set/clear register */
  volatile unsigned long lcdris;             /* LCD raw interrupt status register */
  volatile unsigned long lcdmis;             /* LCD masked interrupt status register */
  volatile unsigned long lcdicr;             /* LCD interrupt clear register */
  volatile unsigned long lcdupcurr;          /* LCD upper panel current address value register */
  volatile unsigned long lcdlpcurr;          /* LCD lower panel current address value register */
  volatile unsigned long reservedclcdc0[115];/* LCD reserved */
  volatile unsigned long lcdpalette[128];    /* LCD palette registers */
  volatile unsigned long reservedclcdc1[256];/* LCD reserved */
  volatile unsigned long cursorimage[256];   /* LCD cursor image */
  volatile unsigned long clcdcrsrctrl;       /* LCD cursor control register */
  volatile unsigned long clcdcrsrconfig;     /* LCD cursor configuration register */
  volatile unsigned long clcdcrsrpalette0;   /* LCD cursor palette register */
  volatile unsigned long clcdcrsrpalette1;   /* LCD cursor palette register */
  volatile unsigned long clcdcrsrxy;         /* LCD cursor xy position register */
  volatile unsigned long clcdcrsrclip;       /* LCD cursor clip position register */
  volatile unsigned long reservedclcdc2[2];  /* LCD reserved */
  volatile unsigned long lcdcrsrimsc;        /* LCD cursor interrupt mask set/clear register */
  volatile unsigned long lcdcrsrris;         /* LCD cursor raw interrupt status register */
  volatile unsigned long lcdcrsrmis;         /* LCD cursor masked interrupt status register */
  volatile unsigned long lcdcrsricr;         /* LCD cursor interrupt clear register */
} CLCDC_REGS_T;
