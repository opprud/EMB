...
typedef enum
{
   CAN_SET_BAUD_RATE, /* Set CAN baud rate, use an argument type
    of CAN_BAUD_RATE_T to set the rate */
   CAN_AUTO_SET_BAUD_RATE, /* Detect the bus baudrate and set the
    CAN baud rate accordingly */
   CAN_SET_FILTER, /* Set CAN Filter bits... TODO */
   CAN_SET_MODE, /**/
   CAN_GET_STATUS, /* Returns CAN status for the selected arg type
    of CAN_IOCTL_STS_T */
...
typedef enum
{
   ...
   CAN_BAUD_RATE, /* Returns bps rate, an enumeration of type
    CAN_BAUD_RATE_T */
   CAN_FILTER_BITS, /* Returns the number of data bits (5 to 8) */
   CAN_MASK_BITS, /* Returns parity, an enumeration of type
    CAN_PARITY_T */
   CAN_DATA_OVERRUN, /* Returns DOS, Data Overrun Status */
   CAN_ERROR_STATUS, /* Returns ES, Error Status, TRUE if RX or TX
    errors has reached EWL (EWL is 96 as default) */
   CAN_BUS_STATUS, /* Returns BS, Bus Status, TRUE if TX
    errors has reached 255 */
