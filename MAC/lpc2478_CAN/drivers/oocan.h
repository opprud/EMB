...
typedef struct
{
	int Frame; 	// Bits 16..19: DLC - Data Length Counter
					// Bit 30: Set if this is a RTR message
					// Bit 31: Set if this is a 29-bit ID message
	int MsgID;	// CAN Message ID (11-bit or 29-bit)
//	char Data[8];
	int DataA;	// CAN Message Data Bytes 0-3
	int DataB;	// CAN Message Data Bytes 4-7
} CAN_MSG;
...
int CAN2_SendMessage( CAN_MSG* pTXBuf );
