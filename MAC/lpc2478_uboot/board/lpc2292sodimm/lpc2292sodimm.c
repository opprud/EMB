...
int board_init (void)
{
	...
	gd->bd->bi_boot_params = 0x81000100;
...
void print_board_banner(void)
{
  ...
  printf("\n\n\r**************************************************\n"
               "* LPC2292 SO-DIMM Board from Embedded Artists AB *\n"
               "*                 EA-version: 1.8                *\n"
...
{
  printf("CPU:   LPC2292 (ARM7tdmi-s from NXP)\n"
         "       running at 58.9824 MHz (14.7456 MHz crystal)\n");
  return 0;
}
