...
/* we always count down the max. */
 ...
 #define TIMER_LOAD_VAL 0 //0xffffffff
 #define READ_TIMER (0xFFFFFFFF - GET32(T0TC)) 
#elif defined(CONFIG_LPC2468) || defined (CONFIG_LPC2478)
 #define TIMER_LOAD_VAL 0 //0xffffffff
...
#elif defined(CONFIG_LPC2292) || defined(CONFIG_LPC2468) || defined(CONFIG_LPC2478)
...
int interrupt_init (void)
{
	...
	PUT32(T0PR, CFG_SYS_CLK_FREQ / CFG_HZ-1);
 	PUT32(T0MCR, 0);
	PUT32(T0TC, 0);
	...
	T0PR  = CFG_SYS_CLK_FREQ / CFG_HZ-1;
 	T0MCR = 0;
	T0TC  = 0;
...
#if defined(CONFIG_IMPA7) || defined(CONFIG_EP7312) || defined(CONFIG_NETARM) || defined(CONFIG_ARMADILLO) || defined(CONFIG_LPC2292) || defined(CONFIG_LPC2468) || defined (CONFIG_LPC2478)
...
void udelay (unsigned long usec)
{
	...
	if( usec < 1000000 ) {
		...
		/* large delays (up to: 214 seconds) */
		tmo = ((usec / 10000) * CFG_HZ) / 100;
	}
