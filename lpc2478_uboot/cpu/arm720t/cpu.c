...
int cleanup_before_linux (void)
{
  ...
  disable_interrupts();
  {
    ...
    *(volatile unsigned int *)U0IER = 0;
    *(volatile unsigned int *)U1IER = 0;
    for(i=0; i<16; i++)
    {
      dummy = *(volatile unsigned int *)U0RBR;
      dummy = *(volatile unsigned int *)U0LSR;
      dummy = *(volatile unsigned int *)U0IIR;
      dummy = *(volatile unsigned int *)U1RBR;
      dummy = *(volatile unsigned int *)U1LSR;
      dummy = *(volatile unsigned int *)U1IIR;
    }
  }
